    ...
    <div>
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img
            src="https://images.unsplash.com/photo-1600573472592-401b489a3cdc?auto=format&fit=crop&w=1600&q=70"
            alt="Polished granite kitchen countertop installation"
            className="h-full w-full object-cover object-center opacity-60 md:opacity-70"
            loading="eager"
            decoding="async"
            fetchPriority="high"
          />
          <div className="absolute inset-0 bg-slate-950/60" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,#334155,transparent_60%)] mix-blend-overlay" />
        </div>
        <div className="mx-auto max-w-7xl px-6 pt-28 pb-32 relative">
